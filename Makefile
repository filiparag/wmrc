...
install:
	...
	install -dm 755 /usr/share/fish/completions
	install -Dm 644 ./completions.fish /usr/share/fish/completions/wmrc.fish
...
uninstall:
	...
	rm -f /usr/share/fish/completions/wmrc.fish
